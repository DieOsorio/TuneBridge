...
export default function Hashtag() {
  ...
  const { data: posts = [], isLoading: isLoadingPosts, error: errorPosts } = searchPosts(`#${hashtag}`);
  const { data: profiles = [], isLoading: isLoadingProfiles, error: errorProfiles } = searchProfiles(`#${hashtag}`);
        ...
        {view === "posts" && (
          <div className="mx-auto text-center md:col-span-2">
            ...
            {isLoadingPosts ? (
              ...
              <PostsList posts={posts} disableSearch />
            ) : (
